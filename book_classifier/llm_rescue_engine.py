...
def build_batch_prompt(items, temas_vocab=None, librerias=None):
    ...
    return (
        ...
        "4. Pregunta clave: la relacion amorosa, es un PILAR CENTRAL de la trama? "
        "Si SI lo es, va a 'Romantasy / Paranormal', sea el elemento fantastico, "
        "paranormal (vampiros, lobos, brujas, angeles) o alienigena/sci-fi (seres "
        "de otro planeta que conviven con humanos, p.ej. la serie Lux de J.L. "
        "Armentrout / los Luxen). Si NO lo es (el romance es secundario o menor), "
        "gana el GENERO: 'Fantasía' para la fantasia epica/de mundo, 'Ciencia "
        "Ficción' para la sci-fi de ideas. NO basta con que haya romance o escenas "
        "picantes: el amor tiene que ser un hilo principal.\n"
