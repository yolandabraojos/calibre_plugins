...
powershell -Command "Compress-Archive -Path __init__.py, action.py, classifier.py, config.py, jobs.py, plugin-import-name-%PLUGIN_NAME%.txt, images -DestinationPath '%OUTPUT_DIR%\%PLUGIN_NAME%-v%PLUGIN_VERSION%.zip' -Force"
