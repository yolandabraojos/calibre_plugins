...
set PLUGIN_NAME=extract_metadata
...
powershell -Command "Compress-Archive -Path __init__.py, action.py, extractor.py, jobs.py, plugin-import-name-%PLUGIN_NAME%.txt, README.md, images -DestinationPath '%OUTPUT_DIR%\%PLUGIN_NAME%-v%PLUGIN_VERSION%.zip' -Force"
